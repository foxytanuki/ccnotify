...
import { CCNotifyError, ErrorType, type DiscordCommandArgs } from '../../../src/types/index.js';
...
describe('discord command', () => {
    ...
    describe('handleDiscordCommand', () => {
        it('should create local Discord hook successfully', async () => {
            ...
            expect(mockHookGenerator.generateDiscordHook).toHaveBeenCalledWith('https://discord.com/api/webhooks/123/valid-token');
        ...
        it('should hide webhook token in success message', async () => {
            mockValidateAndSanitizeDiscordUrl.mockReturnValue('https://discord.com/api/webhooks/123456789/very-secret-token-here');
